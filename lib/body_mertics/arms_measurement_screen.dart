...
class ArmsMeasurementScreen extends StatefulWidget {
  const ArmsMeasurementScreen({super.key});

  @override
  State<ArmsMeasurementScreen> createState() => _ArmsMeasurementScreenState();
}

class _ArmsMeasurementScreenState extends State<ArmsMeasurementScreen> {
  bool isCm = true; // true = cm, false = in
  int selectedArmsCm = 35;
  double selectedArmsIn = 13.8;
  ...
  void initState() {
    super.initState();
    _controllerCm = FixedExtentScrollController(initialItem: selectedArmsCm - 30);
    _controllerIn = FixedExtentScrollController(initialItem: ((selectedArmsIn * 10).round() - 118));
  }
  ...
  void _toggleUnit() {
    setState(() {
      ...
      if (isCm) {
        ...
        selectedArmsCm = (selectedArmsIn * 2.54).round();
        selectedArmsCm = selectedArmsCm.clamp(30, 50);
        ...
        selectedArmsIn = ( selectedArmsCm / 2.54);
      selectedArmsIn =  selectedArmsIn.clamp(11.8, 19.8);
        _controllerIn.animateToItem(
          (( selectedArmsIn * 10).round() - 118),
          duration: const Duration(milliseconds: 300),
          curve: Curves.easeInOut,
        );
      }
    ...
    const SizedBox(height: 20),
          ...
          Text.rich(
            TextSpan(
              children: [
                TextSpan(
                  text: isCm ? '$selectedArmsCm' : '${selectedArmsIn.toStringAsFixed(1)}',
                    ...
                    child: RotatedBox(
                      ...
                      child: ListWheelScrollView.useDelegate(
                        ...
                        onSelectedItemChanged: (index) {
                          setState(() {
                            if (isCm) {
                              selectedArmsCm = cmValues[index];
                            } else {
                              selectedArmsIn = inValues[index];
                            }
                          });
                        },
              ...
              children: [
                const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'Track Arms measurement progress',
                      style: TextStyle(
                        fontSize: 12,
