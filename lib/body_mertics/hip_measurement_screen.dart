...
class HipMeasurementScreen extends StatefulWidget {
  const HipMeasurementScreen({super.key});

  @override
  State<HipMeasurementScreen> createState() => _HipMeasurementScreenState();
}

class _HipMeasurementScreenState extends State<HipMeasurementScreen> {
  bool isCm = true; // true = cm, false = in
  int selectedHipCm = 35;
  double selectedHipIn = 13.8;
  ...
  void initState() {
    super.initState();
    _controllerCm = FixedExtentScrollController(initialItem: selectedHipCm - 30);
    _controllerIn = FixedExtentScrollController(initialItem: ((selectedHipIn * 10).round() - 118));
  }
  ...
  void _toggleUnit() {
    setState(() {
      ...
      if (isCm) {
        ...
        selectedHipCm = (selectedHipIn * 2.54).round();
        selectedHipCm = selectedHipCm.clamp(30, 50);
        ...
        selectedHipIn = ( selectedHipCm / 2.54);
      selectedHipIn =  selectedHipIn.clamp(11.8, 19.8);
        _controllerIn.animateToItem(
          (( selectedHipIn * 10).round() - 118),
          duration: const Duration(milliseconds: 300),
          curve: Curves.easeInOut,
        );
      }
    ...
    const SizedBox(height: 20),
          ...
          Text.rich(
            TextSpan(
              children: [
                TextSpan(
                  text: isCm ? '$selectedHipCm' : '${selectedHipIn.toStringAsFixed(1)}',
                    ...
                    child: RotatedBox(
                      ...
                      child: ListWheelScrollView.useDelegate(
                        ...
                        onSelectedItemChanged: (index) {
                          setState(() {
                            if (isCm) {
                              selectedHipCm = cmValues[index];
                            } else {
                              selectedHipIn = inValues[index];
                            }
                          });
                        },
              ...
              children: [
                const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'Track hip measurement progress',
                      style: TextStyle(
                        fontSize: 12,
