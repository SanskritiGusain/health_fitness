...
class ChestMeasurementScreen extends StatefulWidget {
  const ChestMeasurementScreen({super.key});

  @override
  State<ChestMeasurementScreen> createState() => _ChestMeasurementScreenState();
}

class _ChestMeasurementScreenState extends State<ChestMeasurementScreen> {
  ...
  void _toggleUnit() {
    setState(() {
      ...
      if (isCm) {
        ...
        selectedChestCm = (selectedChestIn * 2.54).round();
        selectedChestCm = selectedChestCm.clamp(30, 50);
                    ...
                    child: RotatedBox(
                      ...
                      child: ListWheelScrollView.useDelegate(
                        ...
                        onSelectedItemChanged: (index) {
                          setState(() {
                            if (isCm) {
                              selectedChestCm = cmValues[index];
                            } else {
                              selectedChestIn = inValues[index];
                            }
                          });
                        },
