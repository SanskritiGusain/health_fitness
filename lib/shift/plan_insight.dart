...
class PlanInsightApp extends StatelessWidget {
  const PlanInsightApp({super.key});
...
class PlanInsightScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   sectionTitle("Plan Progress Insights"),
                  const Text("Plan Progress Plan . Week 7 of 12",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: const [
                      Text("Started - March 5, 2025",
                          style: TextStyle(fontSize: 10, color: Colors.grey)),
                      Text("5 weeks remaining",
                          style: TextStyle(fontSize: 10, color: Colors.grey)),
                    ],
                  ),
                ],
            ...
            Row(
              ...
              children: const [
                InsightCard(title: "Weight Lost", value: "14",unit:"kg"),
                  const SizedBox(width: 10),
                InsightCard(
                    title: "Body Fat", value: "2.1%", isDrop: true,unit:" "),
              ],
            ),
            ...
            const Text("Your weight journey over the past 7 weeks",
...
class InsightCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final valueColor = isDrop
        ? const Color.fromARGB(255, 55, 126, 240)
        : Colors.teal;
              ...
              children: [
                ...
                if (isDrop)
                  const Icon(Icons.arrow_downward,
                      size: 16, color: Color.fromARGB(255, 55, 126, 240)),
              ],
            ),
